...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                        <h2>Hello!</h2>
                        <h3>December 18th, 2022 Bandar Lampung, Indonesia</h3>
    ...
    <script>
        ...
        var d = moment('18/12/2022', 'DD/MM/YYYY').toDate();
